...
Page({
  ...
  data: {
    ...
    areaName: '',
    priority: '',
    addUrl: 'http://127.0.0.1:8082/demo/supperadmin/addarea',
    modifyUrl: 'http://127.0.0.1:8082/demo/supperadmin/modifyarea'
  },
  ...
  onLoad: function(options) {
    ...
    wx.request({
      url: 'http://127.0.0.1:8082/demo/supperadmin/getareabyid',
      data: {
        "areaId": options.areaId,
      },
      method: 'GET',
